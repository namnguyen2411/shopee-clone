export default function ErrorBoundary() {
  return (
    <main className='flex h-screen w-full flex-col items-center justify-center'>
      ...
      <div className='absolute rotate-12 rounded bg-primary px-2 text-sm text-white'>Something went wrong!</div>
      <button className='mt-5'>
        <a
          href='/'
          className='group relative inline-block text-sm font-medium text-white focus:outline-none focus:ring active:text-primary'
        >
