...
import { purchaseStatus } from 'src/constants/queryProductsOptions'
              ...
              <div key={purchase._id} className='mt-4 rounded-sm border-black/10 bg-white text-black shadow-sm'>
                ...
                <div className='bg-stone-50 p-6'>
                  ...
                  <Button
                    ...
                    className='ml-auto mt-5 flex h-10 min-w-[9rem] items-center justify-center rounded-sm bg-primary px-5 text-base capitalize text-white shadow-sm outline-none hover:bg-primary/90'
                  >
                    Mua Lại
                  </Button>
                </div>
